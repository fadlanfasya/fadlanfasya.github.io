...
host('user') // Nama remote host server ssh anda | contoh host('NAMA_REMOTE_HOST')
->setHostname('169.254.190.252') // Hostname atau IP address server anda | contoh  ->setHostname('10.10.10.1') 
->set('user', 'Administrator') // SSH user server anda | contoh ->set('remote_user', 'u1234567')
